  ...
  _template: html`
        ...
        <iron-pages attr-for-selected="id" selected="[[view]]" id="pager">
            ...
            <div id="grownups">
                ...
                <div class="body">
                    We’ll need their help to get you all setup for
            ...
            <div id="email">
                ...
                <template is="dom-if" if="{{!firstName}}">
                    ...
                    <div class="body">
                        Kano accounts need to be associated with an adult’s
                        email address. You’ll be able to see progress in
                        learning to code, creative shares, and medals won.
                    </div>
                </template>
                <form class="fields" on-submit="_onSubmitSignupEmail">
                    ...
                    <div class="checkboxes">
                        ...
                        <div class="checkbox-input">
                            <input type="checkbox" checked="{{newsletter::change}}" id="newsletter"><label for="newsletter">Tick to receive the latest news, offers, promotions and competitions from Kano.</label>
                        </div>
                    </div>
                    <div class="submit-wrapper">
