  ...
  _template: html`
        ...
        <iron-pages attr-for-selected="id" selected="[[view]]" id="pager">
            <div id="login">
                ...
                <div class="footer">
                    Forgot your <a on-tap="showUsernameReminder">username</a>
                    or <a on-tap="showPasswordReset">password?</a><br>
                    No account? <a on-tap="showSignup">Sign up!</a>
                </div>
            </div>
            ...
            <div id="username-reminder">
                ...
                <div class="footer">
                    Back to <a on-tap="showLogin">Login</a><br>
                    No account? <a on-tap="showSignup">Sign up!</a>
                </div>
            </div>
