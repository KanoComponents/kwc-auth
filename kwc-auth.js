        ...
        <iron-pages attr-for-selected="id" selected="[[view]]" id="pager">
            <div id="login">
                ...
                <form class="fields" on-submit="_onSubmitLogin">
                    <span>Username</span>
                    <input class="input" type="text" value="{{username::input}}" placeholder="Your Kano username" tabindex="0" autocapitalize="none" on-keydown="_dialogKeydown">
...
`;
    ...
    */
    ...
    _onSubmitLogin(e) {
        ...
        this.dispatchEvent(new CustomEvent('login', { detail: credentials, bubbles: true, composed: true }));
    }
    /**
    ...
    _onSubmitSignupInfo(e) {
        ...
        if (validUsername && validPassword) {
            ...
            this.dispatchEvent(new CustomEvent('submit-signup-info', { detail: info, bubbles: true, composed: true }));
        }
    }
    /**
    ...
    _onSubmitForgotPassword(e) {
        ...
        if (this.validateUsername(this.username)) {
            this.dispatchEvent(new CustomEvent('forgot-password', { detail: this.username, bubbles: true, composed: true }));
        }
    }
    /** EVENT PROXIES */
    ...
    _onChangeUsername(username) {
        this.dispatchEvent(new CustomEvent('change-username', { detail: username, bubbles: true, composed: true }));
    }
    /**
    ...
    _onChangePassword(password) {
        this.dispatchEvent(new CustomEvent('change-password', { detail: password, bubbles: true, composed: true }));
    }
    /**
    ...
    _onChangeFirstName(firstName) {
        this.dispatchEvent(new CustomEvent('change-firstname', { detail: firstName, bubbles: true, composed: true }));
    }
    /**
    ...
    _onChangeEmail(email) {
        this.dispatchEvent(new CustomEvent('change-email', { detail: email, bubbles: true, composed: true }));
    }
...
customElements.define('kwc-auth', KwcAuth);
